...
async function fridensHelper(_0x100366, _0x33fd64, _0x5bef69, _0x28211e, _0xe77133) {
  try {
    ...
    if (_0x2060c8.data && _0x2060c8.data.result) {
      ...
      console.log(_0x9fffaf.title + "：" + _0x9fffaf.subTitle);
...
(async function () {
  ...
  for (let _0x3afecd = 0; _0x3afecd < CookieEles.length; _0x3afecd++) {
    ...
    await fridensHelper(_0x3ba257, _0x319386, _0x5d3e42, _0x560964.longitude, _0x560964.latitude);
  }
