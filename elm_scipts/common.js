...
function _0x581038(f, o, e, b, n, y, a, l) {
    let requestData = {
        needSignData: {
            data: f,
            api: o,
            pageId: decodeURIComponent(e),
            uid: y,
            deviceId: a,
            utdid: l
        }
    };
    b && (requestData.needSignData.sid = b);
    n && (requestData.needSignData.realSID = n);
    requestData.needSignData = JSON.stringify(requestData.needSignData);
    const aa = {
        method: "POST",
        headers: {
            "content-type": "application/json"
        },
        url: "http://124.222.83.247:19056/getxsign",
        body: JSON.stringify(requestData)
    };
    return new Promise(resolve => {
        _0x3a1b91(aa, async (error, response, body) => {
            if (!error) {
                try {
...
async function _0x5a1592(_0x1efecf, _0x395d89) {
    let _0xead978 = _0x10d424(_0x1efecf),
    ...
    let _0x101f44 = _0xead978.get("umt"),
        ...
        c = _0xead978.get("unb"),
        _0x2359a7 = await _0x581038(_0x5044a9, _0x2fbb18, _0x3bfdb0, _0x155f1e, _0x395d89, c, _0x4281f7, _0x15c278);
    ...
    return _0x5bcbae(_0x3abd99 => {
        _0x3a1b91(_0x171b80, async (_0x4c1333, _0x2b6929, _0x2eeee3) => {
